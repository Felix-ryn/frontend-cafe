...
export default function Pemesanan() {
   ...
   const[id_menu,setIdMenu]=useState("")
    ...
    const [namaPelanggan, setNamaUser] = useState("")
                        ...
                        if (menu.jenis === 'makanan') {
                            return (
                                <div key={menu.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                                    <img className="w-80 h-60 p-8 rounded-t-lg" src={`http://localhost:8080/gambar/${menu.gambar}`} alt="product" />
                            ...
                            <div className="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                                                ...
                                                {pesanan.map((product) => (
                                                    <li key={product.id_menu} className="flex py-6">
                                                        <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                                            <img
                                                              src={`http://localhost:8080/gambar/${product.gambar}`} 
                                                                alt="product"
                                ...
                                <form onSubmit={handleSubmit} className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                    <div>
                                        ...
                                        <input onChange={handleNamaUser} value={namaPelanggan} type="text" id="pelanggan" className="text-sm rounded-lg block w-full p-2.5 bg-transparent border border-gray-200 text-gray-900" autoComplete="off" required />
                                    </div>
                                    <div className="mt-6">
